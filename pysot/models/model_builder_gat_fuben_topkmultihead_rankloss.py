...
class ModelBuilder(nn.Module):
    ...
    def forward(self, data):
        ...
        outputs['total_loss'] = cfg.TRAIN.CLS_WEIGHT * cls_loss + \
            cfg.TRAIN.LOC_WEIGHT * loc_loss + cfg.TRAIN.CEN_WEIGHT * cen_loss+ \
            cfg.TRAIN.RANK_CLS_WEIGHT*CR_loss#+cfg.TRAIN.RANK_IGR_WEIGHT*IGR_loss_1+ \
            #cfg.TRAIN.RANK_IGR_WEIGHT*IGR_loss_2
        outputs['cls_loss'] = cls_loss
        outputs['loc_loss'] = loc_loss
        outputs['cen_loss'] = cen_loss
        outputs['CR_loss'] = CR_loss
        #outputs['IGR_loss_1'] =IGR_loss_1
        #outputs['IGR_loss_2'] = IGR_loss_2
        return outputs

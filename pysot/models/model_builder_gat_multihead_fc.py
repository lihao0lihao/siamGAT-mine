...
class Graph_Attention_Union(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.fc = nn.Linear(in_features=25*4, out_features=25, bias=False)
    def forward(self, zf, xf):
        ...
        zf_trans_plain_1 = zf_trans_1.view(-1, shape_z[1], shape_z[2] * shape_z[3])
        zf_trans_plain_2 = zf_trans_2.view(-1, shape_z[1], shape_z[2] * shape_z[3])
        zf_trans_plain_3 = zf_trans_3.view(-1, shape_z[1], shape_z[2] * shape_z[3])
        ...
        #print ("embeding shape is ",embedding.shape)
        # aggregated feature

...
#from pysot.models.model_builder_gat_mmultihead_fc import ModelBuilder
...
def build_opt_lr(model, current_epoch=0):
    ...
    if cfg.ADJUST.ADJUST:
        print (type(cfg.ADJUST.ADJUST))
        print (cfg.ADJUST.ADJUST)
...
def main():
    ...
    #
    #
    #cfg.TRAIN.RESUME='/mnt/d/lihao/SiamGAT-main/tools/snapshot/got10k_model.pth'
